<template>
  <div id="admin-problemchange">
    <el-row>
      <el-col :span="14" :offset="5">
        <el-card class="admin-problemchange-card">
          <el-form 
            :model="dataForm"
            :rules="rules"
            label-width="120px"
            ...
            <el-form-item
              ...
              :label="'样例' + index"
              :key="sample.key">
              <el-col :span="2" class="admin-changepro-col"><span>输入</span></el-col>
              <el-col :span="7">
                <el-input type="textarea" v-model="sample.sinput"></el-input>
              </el-col>
              <el-col :span="2" class="admin-changepro-col"><span>输出</span></el-col>
              <el-col :span="7">
                <el-input type="textarea" v-model="sample.soutput"></el-input>
              </el-col>
              <el-button class="admin-changepro-button" @click.prevent="deleteSample(sample)">删除</el-button>
            </el-form-item>
            <el-form-item>
...
export default {
  ...
  created() {
    this.nowProblemID = this.$route.params.problemID;
  }
...
.admin-changepro-button {
  margin-left: 20px;
}
.admin-problemchange-card {
  margin-top: 20px;
  margin-bottom: 80px;
}
</style>